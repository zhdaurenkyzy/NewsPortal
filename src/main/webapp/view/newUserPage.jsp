    ...
    <div id="main">
        ...
        <article class="post">
            ...
            <form:form method="POST" action="/admin/addUser" modelAttribute="user">
                ...
                <header>
                    <h1><spring:message code="label.newUser"/></h1>
                    <div class="meta">
                    ...
                    <div class="title">
                        ...
                        <c:forEach var="role" items="${roleList}">
                            <input type="radio" path="role" class="radio" id="demo-priority-normal${role}"
                                   name="roleRadio" value="${role}"/>
                            <label path="role" for="demo-priority-normal${role}">${role}</label>
                        </c:forEach>
                    </div>
                </header>
                ...
                <ul class="actions">
                    ...
                    <li><input type="submit" value=<spring:message code="label.signUp"/>></li>
